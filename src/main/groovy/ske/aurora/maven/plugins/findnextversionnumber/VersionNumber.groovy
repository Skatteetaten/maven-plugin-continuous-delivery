...
class VersionNumber implements Comparable<VersionNumber> {
    ...
    public static VersionNumber parse(String versionString) {
        ...
        return new VersionNumber((versionString - snapshot_notation).tokenize("."), versionString.endsWith(snapshot_notation))
    }
    ...
    public int compareTo(VersionNumber other) {
        ...
        def versionSnapshotAndLengthComparison = versionAndSnapshotComparison + (this.versionNumberSegments.size() <=> other.versionNumberSegments.size())
    ...
    public VersionNumber unlockVersion() {
        return new VersionNumber(versionNumberSegments + 0)
    }
